...
*NOTE:* If having connection problem while downloading the wheel in the terminal, refer [here](https://github.com/hamidrezafahimi/instructor_archive/tree/main/python/pip.md) for instruction. The proper wheel can be found [here](https://pypi.tuna.tsinghua.edu.cn/simple/torch/).